...
export default function CodeRefactoring() {
  ...
  return (
    <div className="container mx-auto py-10">
      <h1 className="text-4xl font-bold mb-8">Code Refactoring</h1>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        <Card>
          ...
          <CardContent className="space-y-4">
            ...
            <Button onClick={handleRefactor} disabled={isLoading || !code.trim()} className="w-full">
              {isLoading ? (
                <>
        ...
        <Card>
          ...
          <CardContent>
            <div className="editor-container">
              {refactoredCode ? (
                <CodeEditor value={refactoredCode} language={language} readOnly={true} />
              ) : (
